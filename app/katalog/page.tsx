...
const CATEGORIES = [
  ...
  { key: 'laser', label: 'Lasery', icon: '🔬' },
  { key: 'hifu', label: 'Urządzenia HIFU', icon: '💎' },
  { key: 'depilacja', label: 'Depilacja laserowa', icon: '✨' },
  { key: 'plazma', label: 'Urządzenia plazmowe', icon: '⚡' },
  { key: 'mikronakłuwanie', label: 'Mikronakłuwanie', icon: '💉' },
  { key: 'inne', label: 'Inne urządzenia', icon: '🏥' },
];
  ...
  return (
    <div className="relative w-full pt-24 min-h-screen">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 py-12 md:py-16 flex flex-col gap-8">
        ...
        {/* Siatka produktów */}
        {!loading && (
          <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 z-[-100]">
