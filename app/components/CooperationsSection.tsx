...
export default function CooperationsSection({}: CooperationsSectionProps) {
  const cooperations = [
    ...
    },
    {
      ...
      subtitle: "Manager ds. Programu Ambasadorskiego",
      description: "Ekspertka kosmetologii zaawansowanej. Odpowiada za strategiczną komunikację, rozwój wizerunku i zarządzanie programem ambasadorek. Prowadzi gabinety w Niemczech i Polsce.",
